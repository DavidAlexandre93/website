<?php
	...
	if(checkValues($_REQUEST['comment_text']) && $_REQUEST['post_id'])
	{
		...
		mysqli_query("INSERT INTO facebook_posts_comments (post_id,comments,userip,date_created) VALUES('".$_REQUEST['post_id']."','".checkValues($_REQUEST['comment_text'])."','".$userip."','".strtotime(date("Y-m-d H:i:s"))."')");
