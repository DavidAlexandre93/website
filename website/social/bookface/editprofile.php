	  ...
	  echo '<div class="currentcity1">';
		...
		echo 'Birthday';
          ...
          echo '<select name="month" id="month">';
			...
			echo '</option>';
			$month=$row['month'];
			$name= mysqli_query("select * from month where month !='$month'");
...
echo'</option>';
          ...
          echo '<select name="day">';
			...
			echo '</option>';
			$day=$row['day'];
			$name= mysqli_query("select * from day where day !='$day'");
             while($res= mysqli_fetch_assoc($name))
{
echo '<option>';
echo $res['day'];
echo'</option>';
          ...
          echo '<select name="year">';
			...
			echo '</option>';
			$year=$row['year'];
			$name= mysqli_query("select * from year where year !='$year'");
            while($res= mysqli_fetch_assoc($name))
{
echo '<option>';
echo $res['year'];
