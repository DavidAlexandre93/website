...
<?php
include("config.php");
$qry = mysqli_query("SELECT * FROM members");
echo " - ".mysqli_num_rows($qry)." membros.";
?></div>
    ...
    <?php
include("config.php");
$name= mysqli_query("select * from month");
...
?>
 &nbsp;<?php
include("config.php");
$name= mysqli_query("select * from day order by day_id asc");
...
?>
    <?php
include("config.php");
$name= mysqli_query("select * from year");
