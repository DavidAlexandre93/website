...
include("config.php");
	...
	//Create INSERT query
	mysqli_query("UPDATE members SET hometown='$location', Interested='$Interested', language='$language', college='$college', highschool='$highschool', experiences='$experiences', arts='$arts', aboutme='$aboutme' WHERE member_id='$user'");
