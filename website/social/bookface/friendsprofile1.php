...
include("config.php");
	...
	$info=$_GET['id'];
$result = mysqli_query("SELECT * FROM friendlist WHERE friends_id='$info'");
...
include("config.php");
	$member_id = $_GET['id'];
			$result1 = mysqli_query("SELECT * FROM friendlist WHERE friends_id = $member_id");
...
$result = mysqli_query("SELECT * FROM photos WHERE uploadedby='$uploaded'");
	
	$numberOfRows = MYSQLI_NUMROWS($result);
	$photo=$_GET['id'];
$result = mysqli_query("SELECT * FROM friendlist WHERE friends_id='$photo'");
...
$result = mysqli_query("SELECT * FROM friendlist WHERE addby='$friendlist' and status='accepted' ");
...
$result = mysqli_query("SELECT * FROM friendlist WHERE addby='$friendlist' and status='accepted' ORDER BY RAND() LIMIT 4");
...
$result = mysqli_query("SELECT * FROM friendlist WHERE addby!='". $_SESSION['SESS_FIRST_NAME'] ."' and firstname!='". $_SESSION['SESS_FIRST_NAME'] ."' ORDER BY RAND() LIMIT 4");
