...
<link rel="stylesheet" href="//maxcdn.bootstrapcdn.com/bootstrap/3.3.1/css/bootstrap.min.css">
 ...
 $to = "davidalexandrefernandes@outlook.com";
 $remetente = "davidalexandrefe@davidalexandrefernandes.com.br"; // Deve ser um email válido do domínio
 ...
 if(mail($to, $assunto, $mensagem, $headers))
 {
     ...
     header("Location: mensagemenviada.php");
 }
 
 /*mensagem("location:index.php?msg=enviado");*/

     else
     {
      echo "<br><br><center><b><font color='red'>Ocorreu um erro ao enviar a mensagem!";
      header("Location: mensagemfalha.php");
 }
 ?>